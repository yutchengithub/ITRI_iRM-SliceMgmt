...
//   }
  ...
  updateUploadFileInfo(body: any): Observable<any> {
    const url = `${this.restPath}/updateUploadFileInfo`;
    const bodyStr = JSON.stringify(body);
    return this.http.post(url, bodyStr);
  }
  uploadFileInfo(body: any): Observable<any> {
    const url = `${this.restPath}/uploadFileInfo`;
    const bodyStr = JSON.stringify(body);
    return this.http.post(url, bodyStr);
  }
  removeUploadFileInfo(httpOptions: any): Observable<any> {
    const url = `${this.restPath}/removeUploadFileInfo`;
    return this.http.delete( url, httpOptions );
  }
  ...
  queryUserInfo(userId: string): Observable<any> {
    const url = `${this.restPath}/queryUserInfo/${this.getSessionId()}/${userId}`;
    return this.http.get(url);
  }
